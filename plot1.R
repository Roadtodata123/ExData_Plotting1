##
## This script produces the graph Plot 1 as specified  on
...
library(datasets)
#plot1 - plot histogram and output the graph to PNG file
hist(mysubdata$Global_active_power, breaks=12, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
